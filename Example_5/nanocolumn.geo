...
Physical Surface("substrate") = {1}; //n_contact
Physical Surface("GaN_side_surface") =  GaN_side_surface[];    //GaN side surfaces
Physical Surface("AlGaN_side_surface") =  AlGaN_side_surface[];  //AlGaN side surfaces
